(function () {
    ...
    var FaqTemplate = function (element) {
        ...
        this.faqContainer =
            this.element.getElementsByClassName("cd-faq__items")[0];
        this.faqsCategoriesContainer =
            this.element.getElementsByClassName("cd-faq__categories")[0];
        this.faqsCategories =
            this.faqsCategoriesContainer.getElementsByClassName(
                "cd-faq__category"
            );
        this.faqOverlay =
            this.element.getElementsByClassName("cd-faq__overlay")[0];
    ...
    function initFaqEvents(faqs) {
        ...
        faqs.faqsCategoriesContainer.addEventListener(
            "click",
            function (event) {
                ...
                if (mq == "mobile") {
                    ...
                    var selectedSection =
                        faqs.faqContainer.getElementsByClassName(
