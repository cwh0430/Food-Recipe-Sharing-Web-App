...
//review and rating
Route::get('/review/{id}', [ReviewController::class, 'showReview'])->middleware('can:isUser');
Route::post('/review/{id}', [ReviewController::class, 'review'])->name('review')->middleware('can:isUser');
